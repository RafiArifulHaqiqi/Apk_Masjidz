...
import '../modules/RiwayatDonasi/bindings/riwayat_donasi_binding.dart';
import '../modules/RiwayatDonasi/views/riwayat_donasi_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.RIWAYAT_DONASI,
      page: () => RiwayatDonasiView(),
      binding: RiwayatDonasiBinding(),
    ),
  ];
}
